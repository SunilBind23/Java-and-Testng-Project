package com.eva.OpenCart.Webutils;
...
//	public void createExtentObject(String LocationOfReport) {
//		extRepo = new ExtentReports();
//		ExtentSparkReporter extSpark = new ExtentSparkReporter(LocationOfReport);
//		extRepo.attachReporter(extSpark);
//	}
//
//	public void GeneraeTest(String TestName) {
...
// method 1
	...
	// method 4
	public void InputData(WebElement element, String data, String tblbox) {
...
//			et.log(Status.INFO, product.get(i).getText() + "found successfull");
	...
	// method 34
	public void UploadFile(WebElement element, String imgPath, String tablebox) {
		try {
			// xpath===By.xpath("//input[@type='file'] formate xapth same
			// getWebElement( locator);
			// el.sendKeys(imgPath);
			InputData(element, imgPath, tablebox);
	...
	public void verifyInnerText(WebElement element, String expectedText) {
		try {
			...
			if (ActualText.equals(expectedText)) {
				...
				et.log(Status.FAIL,element.getText() + " Text verification failed. Expected :-" + expectedText);
			}
		} catch (Exception e) {
