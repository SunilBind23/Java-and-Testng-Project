...
public class GenericMethodsForAutomation {
	// private WebDriver driver;

	private WebDriver driver;
	private static ExtentReports extRepo;
	...
	//	}
	public void createExtentObject() {
		extRepo = new ExtentReports();
		ExtentSparkReporter extSpark = new ExtentSparkReporter("D:\\OpenCartProject\\RegisterFunctionality.html");
		extRepo.attachReporter(extSpark);
	}

	public void createTest(String TestName) {
		et=  extRepo.createTest(TestName);
	}
	...
	public List<WebElement> getWebElements(By locator) {
		...
		try {
			...
			for (int i = 0; i <= elements.size() - 1; i++) {
				...
				et.log(Status.INFO, elements.get(i).getText() + " element" + i);
			}
		} catch (Exception e) {
	...
	// method 5
	public void Click(By locator, String data) {
	...
	// method 35
	public void switchMyFrameBuIndex(int enterIndexNumber) {
		try {
	...
	public void myHeadlessBrowser() {
		...
		try {
			myChromeOptionsObjcets().addArguments("--headless");
	...
	public void myIncognitoMode() {
		...
		try {
			myChromeOptionsObjcets().addArguments("--incognito");
	...
	//	method 45
	public void myJavaScriptScrollIntoView(WebElement we) {
	...
	public void jsClick(WebElement element) {
		try {
			myjavaScriptObj().executeScript("arguments[0].click();", element);
	...
	public void jsScrollToElement(WebElement element) {
		try {
			myjavaScriptObj().executeScript("arguments[0].ScrollToElement();", element);
	...
	public void jsScrollToBottom(WebElement element) {
		try {
			...
			myjavaScriptObj().executeScript("arguments[0].scrollIntoView();", element);
	...
	public void jsScrollDown() {
		try {
			...
			myjavaScriptObj().executeScript("window.scrollBy(0, 500);");
